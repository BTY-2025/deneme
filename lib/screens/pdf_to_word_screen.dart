...
import 'pdf_to_word_success_screen.dart';
...
class _PdfToWordScreenState extends State<PdfToWordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Step 3: Docx dosyası oluşturuluyor
                        ...
                        children: [
                          ...
                          Center(
                            child: Column(
                              children: [
                                Text(
                                  isCompleted ? 'word.conversion_completed'.tr() : 'word.converting'.tr(),
                                  style: GoogleFonts.getFont(
                                    'Inter',
                                    textStyle: const TextStyle(
                                      fontSize: 20,
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    isCompleted
                                        ? 'word.conversion_success_desc'.tr()
                                        : 'word.converting_desc'.tr(),
                                    style: GoogleFonts.getFont(
                                      'Inter',
                                      textStyle: TextStyle(
                                        fontSize: 16,
                              ...
                              children: [
                                ...
                                _buildStepRow(
                                  ...
                                  iconWidget: SvgPicture.asset(
                                    ...
                                    width: 23,
                                    height: 23,
                                    colorFilter: ColorFilter.mode(step2Color, BlendMode.srcIn),
                                  ),
                                ...
                                _buildStepRow(
                                  ...
                                  color: step3Color,
                                  iconWidget: _DocxFileCustomIcon(
                                    color: step3Color,
                                  ),
                            ...
                            onTap: isCompleted
                                ? () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => PdfToWordSuccessScreen(
...
class _DocxFileCustomIcon extends StatelessWidget {
  final Color color;

  const _DocxFileCustomIcon({required this.color});

  @override
  Widget build(BuildContext context) {
    const double frameSize = 32.0;
    return SizedBox(
      width: frameSize,
      height: frameSize,
      child: Stack(
        children: [
          // Outer Vector
          Positioned(
            left: frameSize * 0.1268,
            right: frameSize * 0.1268,
            top: frameSize * 0.0841,
            bottom: frameSize * 0.0841,
            child: Container(
              decoration: BoxDecoration(
          ...
          // Inner Vector
          Positioned(
            left: frameSize * 0.375,
            right: frameSize * 0.375,
            top: frameSize * 0.375,
            bottom: frameSize * 0.375,
            child: Container(
              decoration: BoxDecoration(
                border: Border.all(color: color, width: 1.5),
              ),
